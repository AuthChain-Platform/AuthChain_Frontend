...
const LandingPageii = () => {
  return (
    <div className="flex flex-col items-center p-16">
      ...
      <div className="flex flex-col lg:flex-row items-center lg:items-stretch space-x-10 p-4">
  <img
    src="/group.png"
  ...
  <div className="flex flex-col text-left h-full">
    <p className="text-4xl text-[#2711F1] font-light mb-7">
      Combat Counterfeiting
    </p>
    <p className="text-2xl text-gray-700 w-full lg:w-[90%] xl:w-[80%] mb-14">
