...
//     {
//       inputs: [
//         { internalType: "uint256", name: "productCode", type: "uint256" },
//       ],
//       name: "getProductDetails",
//       outputs: [
...
//       ]);
//       setProductData(data);
//       setPreviewState({ isLoading: false, isError: false, errorMessage: null });
//     } catch (error) {
//       console.error("Smart contract error:", error);
//       setPreviewState({
//         isLoading: false,
...
//                 <div
//                   id="reader"
//                   className="w-full h-[300px] bg-gray-100 border rounded-lg"
//                 ></div>
//               )}
//             </div>
//           </div>
...
//           {productData && (
//             <div className="p-6">{JSON.stringify(productData)}</div>
//           )}
//         </div>
//       </div>
//     </div>
